 ...
 * 用法:
 *   node scripts/tools/get-merchant-cookie.js                     # 自动发现 hicustom 页面(默认端口19012)
 *   node scripts/tools/get-merchant-cookie.js <cdp-port>          # 指定 CDP 端口
 *   node scripts/tools/get-merchant-cookie.js ws://.../page/<id>  # 直接给页面 target ws
